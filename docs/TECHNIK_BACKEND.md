...
| `product_master/{ean}` | Gemeinsamer Artikelname je EAN + gelernte `default_vpe` (übliche Stückzahl) für künftige Wareneingänge | read: Mandanten-Nutzer; create/update: Employee/Admin; delete: Admin |
